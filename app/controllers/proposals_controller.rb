class ProposalsController < ApplicationController
  ...
  private
    ...
    def proposal_params
      params.require(:proposal).permit(:user_id, :purchase_type_id, :car_quality_type_id, :make, :model, :year, :exterior_color, :interior_color, :price, :over_under_price, :down_payment, :lease_length, :mileage_limit, :closing_cost, :financing, :apr, :deadline)
    end
end
